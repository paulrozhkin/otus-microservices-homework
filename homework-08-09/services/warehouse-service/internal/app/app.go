...
import (
	...
	"github.com/paulrozhkin/otus-microservices-homework/otus-microservices-homework-08-09/services/warehouse-service/internal/consumer"
	httpdelivery "github.com/paulrozhkin/otus-microservices-homework/otus-microservices-homework-08-09/services/warehouse-service/internal/delivery/http"
	"github.com/paulrozhkin/otus-microservices-homework/otus-microservices-homework-08-09/services/warehouse-service/internal/repositories"
	"go.uber.org/zap"
...
func New(cfg config.Config) (*App, error) {
	...
	repository := repositories.NewWarehouseRepository(db, outboxRepository)
