...
func configureReader(v *viper.Viper) error {
	...
	v.AddConfigPath("./services/user-service/config")
...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("billing.baseUrl", "http://billing-service")
	v.SetDefault("billing.timeout", 5*time.Second)
}
...
func bindEnvs(v *viper.Viper) error {
	envs := map[string]string{
		...
		"billing.baseUrl":      "OTUS_USER_SERVICE_BILLING_BASE_URL",
		"billing.timeout":      "OTUS_USER_SERVICE_BILLING_TIMEOUT",
	}
